    ...
    public function createOrder(User $user, array $cartItems, array $shippingData, ?string $couponCode = null): Order
    {
        return DB::transaction(function () use ($user, $cartItems, $shippingData, $couponCode) {
            ...
            $order = Order::create([
                ...
                'order_type' => 'online',
                'order_source' => $shippingData['order_source'] ?? 'website',
                'utm_source' => $shippingData['utm_source'] ?? null,
                'utm_medium' => $shippingData['utm_medium'] ?? null,
                'utm_campaign' => $shippingData['utm_campaign'] ?? null,
                'utm_content' => $shippingData['utm_content'] ?? null,
                'utm_term' => $shippingData['utm_term'] ?? null,
                'referrer_url' => $shippingData['referrer_url'] ?? null,
